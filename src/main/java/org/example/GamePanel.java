...
public class GamePanel extends JPanel implements Runnable {
    ...
    private static final int panelHeight = 640;

    private static Image background;
    private static Image rightBorder;
    private static Image leftBorder;
    private static List<Platform> gamePlatforms;
    private static Player player;

    private final List<Image> platformTypes;
    private boolean inGame;
    private boolean scroll;

    private Audio fall;
    private Audio tryAgain;
    ...
    private void loadImages() {
        ...
        rightBorder = new ImageIcon(getClass().getResource("/images/RightBorder.png")).getImage();
        leftBorder = new ImageIcon(getClass().getResource("/images/LeftBorder.png")).getImage();

        Image center, left, right;
        int numOfLevels = 2;
        for (int i = 1; i <= numOfLevels; i++) {
            left = new ImageIcon(getClass().getResource("/images/Level" + i + "Left.png")).getImage();
            center = new ImageIcon(getClass().getResource("/images/Level" + i + "Center.png")).getImage();
            right = new ImageIcon(getClass().getResource("/images/Level" + i + "Right.png")).getImage();
            createFloor(left, center, right);
        }
    }

    private void loadSound() {
        Audio greeting = new Audio("/audio/greeting.wav");
        fall = new Audio("/audio/falling.wav");
        tryAgain = new Audio("/audio/tryAgain.wav");
    ...
    private void drawObjects(Graphics2D g2d) {
        ...
        for (int i = gamePlatforms.size() - 1; i >= 0; i--) {
            ...
            if (platform.getY() > panelHeight - currentY) {
